       ...
       String et1;
        swich(metodo){
            ...
            switch(metodo){
                ...
                if(this != par.getTipo()) {
                    par=(Instancia) par.generarCodigoMetodo(Metodos.CAST, /*algo */);
                }
        ...
        v=new Variable(newNomObj(),instancia.getBloque());
        PLXC.out.println(instancia.getIDC()+" = "+instancia.getIDC()+";");

        switch (metodo) {
            case Metodos.YLOG: 
                PLXC.out.println("if ("+instancia.getIDC() /*algo */); 
                break;
            case Metodos.OLOG: 
                PLXC.out.println("if ("+instancia.getIDC()); 
                break;
        }
        return v;
